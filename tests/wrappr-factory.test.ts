...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    let wrapprDeploymentEvent = createWrapprDeployedEvent(Address.fromString("0xa16081f360e3847006db660bae1c6d1b2e17ec2a"), 'Test Wrappr', 'TEST', 'ipfs://mock', BigInt.fromI32(234), Address.fromString("0x0000000000000000000000000000000000000002"))
